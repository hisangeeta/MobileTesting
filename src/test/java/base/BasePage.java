...
public class BasePage {
	...
	public void waitForAlertToPresent(Duration timeInsec, String objectName) {
		mylog.info(objectName + "waiting for Alert to be present " + timeInsec + "sec");
		wait = new WebDriverWait(driver, timeInsec);
		wait.until(ExpectedConditions.alertIsPresent());
	}

	public void waitForElementToBeClicked(WebElement ele, int i, String objectName) {
		mylog.info(objectName + "waiting for elemnt to be clicked " + i + "sec");
		wait = new WebDriverWait(driver, Duration.ofSeconds(i));
		wait.until(ExpectedConditions.elementToBeClickable(ele));
	}

	public void waitFortextToBePresent(WebElement ele, int i, String text, String objectName) {
		mylog.info(objectName + "waiting for string to be presend " + i + "sec");
		wait = new WebDriverWait(driver, Duration.ofSeconds(i));
		wait.until(ExpectedConditions.textToBePresentInElement(ele, text));
	}

	public void waitForWindowtToBePresent(Duration timeInsec, int numOfWindows, String objectName) {
	...
	public void waitForTitleToBepresent(Duration timeInsec, String title, String objectName) {
